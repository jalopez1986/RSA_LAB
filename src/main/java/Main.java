...
public class Main {
    ...
    private static void methodOriginal() throws IOException {
        ...
        RandomAccessFile f = new RandomAccessFile("/Users/jlopez/Documents/Veritran/SDKsTeam/Azteca/rsa_test/src/com/company/code.txt", "r");
    ...
    private static void methodCRT() throws IOException {
        BigInteger p, q, N, phiN, d;
        ...
        //Print all of the results
        System.out.println("N = " + N.toString(16));
        System.out.println("Code Digest = " + message.toString());
        System.out.println("Digital Signature = " + myCipher.toString());
        System.out.println("Unencrypted DS = "+ decrypt(e,p,q,myCipher).toString());
    }
